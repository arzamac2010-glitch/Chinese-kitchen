const baseRecipes = [
    ...
    { id: 7, title: "🫔 Хрусткі спрінг-роли", category: "snack", categoryName: "Закуска", emoji: "🫔", description: "Хрусткі обсмажені рулетики з соковитою начинкою.", ingredients: [{ name: "Тісто для спрінг-ролів", amount: 2, unit: "листи" }, { name: "Пекінська капуста та морква", amount: 80, unit: "г" }, { name: "Локшина фунчоза", amount: 20, unit: "г" }, { name: "Олія для фритюру", amount: 100, unit: "мл" }], instructions: "Тонко наріжте овочі,快速обсмажте. Загорніть начинку в листи тіста. Обсмажуйте у великій кількості олії до золотистої скоринки.", time: 35 },
